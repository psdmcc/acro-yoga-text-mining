...
\thanks{Research Affiliate, Anthropological Institute, Nanzan University, Japan; %
School of Culture, History and Language, Australian National University, Australia; %
Centre for Religious Studies, Manipal Academy of Higher Education, India. %
Email: \texttt{u4556787@anu.edu.au}}}
...
\begin{figure}[htbp]
    ...
    \caption[Mid-nineteenth-century gouache on mica depicting Trichinopoly acrobat performances.]{Mid-nineteenth-century gouache on mica depicting Trichinopoly acrobat performances, showing vertical pole-balancing  and suspended rope-somatic dynamics matching the historical \textit{upastambha} layout \cite{VAM2024}. It is necessary to understand that this acrobatic scene is part of an important ritual, and not simply a troupe begging on the street.}
...
\noindent\textit{pātayitvā dharāpṛṣṭhe niṣpipeṣa gatāyuṣam (VP 5.20.66)}
\end{quote}
...
These raw streams are then pushed through a symmetric lookahead matrix to compute localized sliding-window Jaccard Coefficients ($J_{\text{slide}}$) within an inclusive 300-word context envelope, unmasks the hidden occupational intersections separating outcaste performer guilds from scholastic orthopraxy. Finally, the system exposes the ultimate mechanics of the extraction heist through a conceptual filter loop. The active, transitive physical tools of subaltern survival are systematically turned inward, stripped of their names ($N = 0$), and re-engineered into the passive, disembodied, mono-semantic monuments of late-medieval orthodox theology.

\subsection{The Liturgical Mapping of Somatic States and Performer Networks}
Chapter 30 of the \textit{Vājasaneyīsaṃhitā} and Chapter 3.4 of the \textit{Taittirīyabrāhmaṇa} function as systematic state censuses that capture and categorize early Indian specialized and non-Aryan tribal knowledge. Rather than recording literal sacrifices, these manuals construct a proto-pharmacological grid where human archetypes map directly to distinct neurological states, spatial coordinates, and cosmic elements. Within this state archival framework, the administrative mandate pairs the quantitative study of structural anatomy, or \textit{aṅgavidyā}, directly with \textit{jambhakavidyā} -- the subaltern science of metabolic freezing, physical deception, and deceptive camouflage. 
...
\begin{equation}
J_{slide}(T_i, S_j) = \frac{\vert f_W(T_i) \cap f_W(S_j) \vert}{\vert f_W(T_i) \cup f_W(S_j) \vert}
\end{equation}
...
\begin{quote}
\small
\textit{annaṃ daśaguṇaṃ piṣṭaṃ piṣṭād daśaguṇaṃ payaḥ \vert \\
payaso daśaguṇaṃ māṣaṃ māṣād daśaguṇaṃ ghṛtam \vert\vert MP 9.96 \vert\vert \\
māṣeṇa vardhate kāyo ghṛtena vardhate balam \vert \\
piṣṭena vardhate prāṇaḥ śauryaṃ māṃsāt pravardhate \vert\vert MP 9.98 \vert\vert}
\end{quote}
...
\bibitem{narten1965}
J.~Narten, ``Ai. jámbha-, gr. \textgreek{g'omfos} und Verwandtes,'' \textit{Zeitschrift für Vergleichende Sprachforschung auf dem Gebiete der Indogermanischen Sprachen}, vol.~79, no.~3/4, pp. 255--264, 1965. 
