...
\newkeywords{Acro-Yoga Complex, Contortionist Turn, Text-Mining, Statecraft, Subaltern, Espionage, Envenomation}
\end{abstract}
...
% Delete the raw @book blocks at the bottom of the file and paste this block:
...
Kullūkabhaṭṭa (2003). \textit{Manvarthamuktāvalī (Commentary on the Manusmṛti)}. GRETIL Digital Repository. (File node: \texttt{vcpss\_u.htm}).
...
\bibitem[McCartney, 2026]{McCartney2026b}
...
\bibitem[McCartney, 2026]{McCartney2026c}
...
\bibitem[McCartney, 2026]{McCartney2026d}
...
\bibitem[McCartney, 2026]{McCartney2026e}
McCartney, Patrick S. D. (2026). \textit{The Somatic Cartel: Graph-Theoretic Corroboration of Fluid-Extraction Matrices and Antinomian Liturgies in Late Antique Heresiology}. Unsubmitted draft manuscript, repository: \texttt{psdmcc/great-mystery-map}.
...
\bibitem[Pinch, 2012]{Pinch2012b}
Pinch, William R. (2012). \textit{The Slave Guru: Masters, Commanders, and Disciples in Early Modern India}. New York: Oxford University Press.

\bibitem[Pinch, 2020]{Pinch2020}
Pinch, William R. (2020). \textit{The Yogi's Way of War: An Intellectual History of the Militant Gosains}. New Delhi: Oxford University Press.
...
\bibitem[Hillman, 2008]{Hillman2012}
Hillman, David C. A. (2008). \textit{The Chemical Muse: Drug Use and the Roots of Western Civilization}. New York: Thomas Dunne Books.
