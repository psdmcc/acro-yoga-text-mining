...
% =============================================================================
% 1. CORE SYSTEM PREAMBLE (OPTMIZED FOR LUALATEX ENGINE COMPILATION)
% =============================================================================
\usepackage{fontspec}           % Modern system font manager (Requires LuaLaTeX/XeLaTeX)
\usepackage{geometry}           % Page margin layout manager
\geometry{letterpaper, margin=1in}
\usepackage{amsmath, amssymb}   % Structural math fonts and symbols
\usepackage{listings}           % Advanced code block container (for data strings/listings)
...
\setmainfont{TeX Gyre Termes}   % Respectable academic serif alternative to Times New Roman
...
% --- Hyperref Routing Aesthetics Setup ---
\hypersetup{
    colorlinks=true,
    linkcolor=blue,
    citecolor=blue,
...
\author{
    ...
    \small Centre for Religious Studies, Manipal Academy of Higher Education, India \\
...
\newkeywords{Acro-Yoga Complex, Contortionist Turn, Text-Mining, Statecraft, Subaltern, Esopnage, Envenomation}
\end{abstract}
...
By the Maurya era, this volatile somatic substrate of the frontier was systematically secularized, institutionalized, and integrated into the centralized espionage operations of the early state. In a critical diagnostic hit from Kautilya’s \textit{Arthaśāstra} (1.12.7313), the sovereign's premier undercover stationary agents (\textit{sattriṇaḥ}) are commanded to master a highly specialized technical curriculum to maintain their performative operational cover along international transit trade lanes:
\begin{quote}
    \textit{ye cāpy asaṃbandhino 'vaśyabhartavyāste lakṣaṇam aṅgavidyāṃ jambhakavidyāṃ māyāgatam āśramadharmaṃ nimittam...} \cite{ArthaŚ}
\end{quote}
...
The earliest high-density intersection isolated on our spatial scatter plot drops squarely into Kautilya’s \textit{Arthaśāstra} (2.5.7313). Long before the physical pillar (\textit{stambha}) was celebrated as an asset for martial conditioning or internal yoga alignment, it operated as a literal instrument of state incarceration and panoptic surveillance. The text explicitly mandates the physical parameters required to construct the centralized imperial treasury and state prison complex:
\begin{quote}
    \textit{pakveṣṭakāstambhaṃ catuḥśālam ekadvāram anekasthānatalaṃ vivṛtastambhāpasāram ubhayataḥ paṇyagṛhaṃ koṣṭhāgāraṃ ca dīrghabahuśālaṃ kakṣyāvṛtakuḍyam antaḥ kupyagṛham tad eva bhūmigṛhayuktam āyudhāgāraṃ pṛthagdharmasthīyaṃ mahāmātrīyaṃ vibhaktastrīpuruṣasthānam apasārataḥ suguptakakṣyaṃ bandhanāgāraṃ kārayet} \cite{ArthaŚ} \\
...
Our advanced sliding-window collocation sweep -- forcing the interaction of vital anatomical nodes (\textit{marman}) and breath pathways (\textit{prāṇa}) alongside clandestinity (\textit{gūḍha}) and performance (\textit{naṭa}) -- pierces directly into the tactical reality behind these somatic skills. Kullūkabhaṭṭa’s classic medieval commentary on the \textit{Manusmṛti} (Verse 7.154), preserved within GRETIL’s \texttt{vcpss\_u.htm} and lexicographed inside the \textit{Śabdakalpadruma} (\texttt{skdss\_u.htm}), explicitly links high-level anatomical knowledge directly to state espionage:
\begin{quote}
    \textit{kāpaṭikodāsthitagṛhapatika-vaidehikavāpasaṃvyañjanātmakaṃ pañcavidhaṃ caravargaṃ tattvatacintayet | tatra kāpaṭikaḥ paramarmajñaḥ pragalbhaś chātraḥ...} \cite{GRETIL_vcp} \\
    \textit{kāpaṭikaḥ, puṃ, (kapaṭena carati iti . kapaṭa + ṭhak .) chātraḥ . anyamarmajñaḥ .} \cite{DCS_skd}
\end{quote}

The state’s premier undercover field agent (\textit{kāpaṭika} / \textit{cara}) is thus lexicographically defined by two explicit attributes: absolute mastery over fraud, disguise, and occupational infiltration (\textit{kapaṭa-vyavahāra}), and a precise, lethal expertise in diagnosing and exploiting the vulnerable, vital nodes of an opponent's body (\textit{paramarmajña} / \textit{anyamarmajña}). 

To ground this operational intersection, the Contortionist Turn rejects the assumption that the state handed corporate espionage badges directly to outcaste acrobats; rather, the centralizing administrative elite executed a top-down technological extraction. The state vampirized the kinetic agility and anatomical precision developed within peripheral performer networks, re-coding the material realities of aggressive, hand-to-hand combat (\textit{niyuddha}) into a weaponized intelligence asset. In the epic accounts of arena duels preserved in the \textit{Harivaṃśa} (HV 75.42) and the \textit{Viṣṇu Purāṇa} (ViP 5.20.66), physical configurations (\textit{āsana}) are contextualized not as instruments of internal isolation, but as violent mechanisms of skeletal destruction:
\begin{quote}
    \textit{prāharan muṣṭinā mūrdhni vakṣasyāhatya jānunā} \\
    \textit{pātayitvā dharāpṛṣṭhe niṣpipeṣa gatāyuṣam} \cite{ViP_5}
\end{quote}
...
The operational transition of \textit{yoga-kṣema} from an epic, pastoral binary into a strategic technology of statecraft is explicitly codified by pairing late-Rigvedic conquest metrics with Kautilyan political science. In the ritual architecture of \textit{Ṛgveda} (7.54.3cd), the binary division of communal activity is strictly partitioned between peace and active warfare (\textit{pāhi kṣema uta yoge}). This framework is inherently aggressive; as detailed in \textit{Ṛgveda} (10.166.5ab), the successful seizure of an adversary’s mobilization capacity and domestic security (\textit{yoga-kṣemaṃ va ādāyāham bhūyāsam}) is structurally validated through visceral, bodily domination and trampling (\textit{uttama ā vo mūrdhānaṃ akramim}). 
...
\begin{quote}
    \textit{mūrdhni kūrmāsanaṃ badhdvā bhajedvāpyekapādake(kam) /} \\
    \textit{uttānapratimallasya nivārya caraṇadvayam //} \cite{Mān_3}
\end{quote}
...
This micro-anatomical targeting aligns perfectly with Epic accounts of unrestricted arena combat. In the \textit{Harivaṃśa} (HV 75.42), Kṛṣṇa’s final strike against Caṇūra is defined as an un-weaponized execution (\textit{aśastram atighoraṃ}) consisting of raw physical power (\textit{balaprāṇaviniṣpādyaṃ}):
\begin{quote}
    \textit{prāharan muṣṭinā mūrdhni vakṣasyāhatya jānunā} \\
    \textit{niḥsṛte sāśrurudhire tasya netre sabandhane} \cite{HV_75}
\end{quote}
The subsequent execution of a crushing ground-hold (\textit{niṣpipeṣa}) in the \textit{Viṣnu Purāṇa} (ViP 5.20.66) demonstrates that deep floor holds were originally weaponized grappling submissions designed to stop an opponent’s vital breath (\textit{prāṇa}). Furthermore, the directional stealth vocabulary of \textit{saṃsarpaṇa} (sneaking, gliding, or launching surprise attacks) and \textit{upasarpaṇa} (deceptive creeping) bridges the tactical space between martial combat and the border-crossing agility of low-caste acrobat guilds (\textit{naṭas}).
...
\begin{quote}
    ...
    \textit{tatsarvaṃ kathayiṣyāmi yogakṣemārthasiddhaye ||} \cite{MP_7}
\end{quote}
...
% =============================================================================
% 1. PRIMARY SANSKRIT EDITIONS & DIGITAL TEXT NODES (GRETIL / DCS / CRITICALS)
% =============================================================================

@book{ArthaS,
    author    = {{Kautilya}},
    title     = {Arthaśāstra of Kautilya},
    editor    = {Kangle, R. P.},
    publisher = {Motilal Banarsidass},
    year      = {1969},
    address   = {Bombay},
    note      = {Digital edition integrated via Hellwig's Digital Corpus of Sanskrit (DCS) node records}
}

@book{KauśP,
    author    = {{Keśava}},
    title     = {Kauśikapaddhati of Keśava},
    editor    = {Limaye, V. P. and Vadekar, R. D.},
    publisher = {Tilak Maharashtra Vidyapeeth},
    year      = {1982},
    address   = {Pune},
    note      = {Atharvavediya ritual handbook tracking weaponized stambhanam matrices}
}

@book{Mān_3,
    author    = {{Someśvara III}},
    title     = {Mānasollāsa of King Bhūlōkamalla Someśvara},
    editor    = {Shorigondekar, G. K.},
    publisher = {Oriental Institute},
    year      = {1939},
    address   = {Baroda},
    series    = {Gaekwad's Oriental Series},
    note      = {Volume II tracking close-quarters grappling and the weaponized kūrmāsana pin}
}

@book{MP_7,
    author    = {{Modha Brahmins}},
    title     = {Mallapurāṇa: A Medieval Sanskrit Text on Malla-yuddha},
    editor    = {Sandesara, B. J. and Mehta, R. N.},
    publisher = {Oriental Institute},
    year      = {1964},
    address   = {Baroda},
    series    = {Gaekwad's Oriental Series},
    note      = {Tracking the fourteen kinetic Lāga grips and acoustic stadium registers}
}

@misc{GRETIL_vcp,
    author    = {{Kullūkabhaṭṭa}},
    title     = {Manvarthamuktāvalī (Commentary on the Manusmṛti)},
    howpublished = {GRETIL Digital Repository},
    year      = {2003},
    note      = {File node: \texttt{vcpss\_u.htm}, isolating the kāpaṭika espionage parameters}
}

@misc{DCS_skd,
    author    = {{Rādhākāntadeva}},
    title     = {Śabdakalpadruma Lexicon data layers},
    howpublished = {Digital Corpus of Sanskrit (DCS)},
    year      = {2010},
    note      = {Lemmatized grammatical entry tracking paramarmajña intelligence attributes}
}

@book{HV_App,
    author    = {{Veda Vyāsa}},
    title     = {The Harivaṃśa: Being the Khila or Supplement to the Mahābhārata},
    editor    = {Vaidya, P. L.},
    publisher = {Bhandarkar Oriental Research Institute},
    year      = {1969},
    address   = {Poona},
    note      = {Critical Appendix 1 tracking tribal Śabara topographies and charnel ground camouflage}
}

@book{ViP_5,
    author    = {{Puranic Composers}},
    title     = {The Viṣṇupurāṇa: With the Commentary of Śrīdhara Svāmī},
    editor    = {Shastri, J. L.},
    publisher = {Motilal Banarsidass},
    year      = {1980},
    address   = {Delhi},
    note      = {Chapter 5 tracking the bone-crushing mechanics of niṣpipeṣa ground holds}
}

% =============================================================================
% 2. FORTHCOMING & RECENT CRITICAL VOLUMES BY PATRICK S.D. McCARTNEY
% =============================================================================
...
@unpublished{McCartney2026e,
    author = {McCartney, Patrick S. D.},
    title  = {The Somatic Cartel: Graph-Theoretic Corroboration of Fluid-Extraction Matrices and Antinomian Liturgies in Late Antique Heresiology},
    note   = {Unsubmitted draft manuscript, repository: \texttt{psdmcc/great-mystery-map}},
    year   = {2026}
}

@book{McCartney2021,
    author    = {McCartney, Patrick S. D.},
    title     = {The Not So United States of Yogaland: Transnational Wellness Capitalism and the Geopolitics of Erasure},
...
% =============================================================================
% 3. RECENT CRITICAL TEXT-HISTORICAL YOGA RESEARCH (JASON BIRCH)
% =============================================================================

@book{Birch2024,
    author    = {Birch, Jason},
    title     = {The \textit{Amaraugha} and \textit{Amaraughaprabodha} of Gorakṣanātha: A Critical Edition with Translation and Study},
    publisher = {Institut Français de Pondichéry / École française d'Extrême-Orient},
    year      = {2024},
    address   = {Pondicherry},
    note      = {Including the 2024 literature review addendum on the Ujjain manuscript of the Yogacintāmaṇi}
}

% =============================================================================
% 4. HISTORIOGRAPHICAL ANCHORS (WARRIOR-ASCETICS, MARTIAL CORPS, SURVEILLANCE)
% =============================================================================
...
@book{Pinch2012b,
    author    = {Pinch, William R.},
    title     = {The Slave Guru: Masters, Commanders, and Disciples in Early Modern India},
...
@book{Pinch2020,
    author    = {Pinch, William R.},
    title     = {The Yogi's Way of War: An Intellectual History of the Militant Gosains},
    publisher = {Oxford University Press},
    year      = {2020},
    address   = {New Delhi}
}

@article{Lorenzen1978,
...
@article{OHanlon2007,
    ...
    pages   = {490--523},
    year    = {2007},
    doi     = {10.1163/156852007783245034}
}
...
% =============================================================================
% 5. TRANSCULTURAL HELLENISTIC MEDICINE & TOXICOLOGY CORE REFS
% =============================================================================

@book{Hillman2012,
    author    = {Hillman, David C. A.},
    title     = {The Chemical Muse: Drug Use and the Roots of Western Civilization},
    publisher = {Thomas Dunne Books},
    year      = {2008},
    address   = {New York},
    note      = {Contextualizing Patristic humoral enclosures and the pharmako-mantis}
}

% =============================================================================
% 6. RECOVERY HISTORICAL VERNACULARS (MARATHI & COLONIAL RECORDS)
% =============================================================================

@book{Patwardhan1927,
    author    = {Patwardhan, N. G.},
    title     = {Malla-Vidy\={a} va Pehalav\={a}n\={i} K\={a}mat [The Science of Wrestling and Pugilistic Maneuvers]},
    publisher = {Chitrashala Press},
    year      = {1927},
address   = {Poona},
note = {Early Marathi manual documenting pavitr={a} readiness and physical stances}}
