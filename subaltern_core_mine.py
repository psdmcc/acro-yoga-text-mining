...
# Standard IAST lowercase substring dictionary mapped precisely to your raw corpus data strings
LEMMA_PATTERNS = {
    'pithasarpin_crawler': [
        r'pīṭhasarp', r'pīṭhasarpī', r'pīṭhasarpina', r'pīṭhasarpibhi', r'pīṭhasarpa'
    ],
    'vaṃśanartin_pole': [
        r'vaṃśanart', r'vaṃśanartin', r'vaṃśanartinam', r'vaṃśanartina', r'vaṃśanartibhi'
    ],
    'stambha_axis': [
        r'stambha', r'stambhan', r'stambh', r'stambhitavya', r'stambham'
    ],
    'sarpa_serpent': [
        r'sarpa', r'sarpin', r'sarpati', r'sarpana', r'sarpiḥ', r'sarpī'
    ],
    'candala_outcaste': [
        r'caṇḍāl', r'caṇḍālam', r'caṇḍālai', r'caṇḍālī', r'caṇḍālas'
    ]
}
...
def scan_text_layers(target_directories):
    """Iterates through all text files running pure substring checks across data blocks."""
    print("[*] Initializing automated IAST substring-anywhere text mining pass...")
    results = []
    ...
    for directory in target_directories:
        ...
        for file_name in files:
            ...
            with open(file_path, 'r', encoding='utf-8', errors='ignore') as f:
                content = f.read().lower() # Force lowercase to align with standard IAST targets
    ...
    if not results:
        ...
        print("[*] Re-verify if text data utilizes an alternate character map configuration.")
        return
    ...
    print("\n" + "="*70)
    print(f"[✓] SUCCESS: Managed IAST substring pipeline run completed cleanly!")
